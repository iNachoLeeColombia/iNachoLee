...
use Netpublic\CoreBundle\Entity\HorarioGrupo;
use Netpublic\CoreBundle\Form\HorarioGrupoType;
...
class HorarioGrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NetpublicCoreBundle:HorarioGrupo')->findAll();
     ...
     *
     * @Route("/{id}/show", name="horariogrupo_show")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NetpublicCoreBundle:HorarioGrupo')->find($id);
    ...
    public function newAction()
    {
        ...
        $form   = $this->createForm(new HorarioGrupoType(), $entity);
     ...
     *
     * @Route("/create", name="horariogrupo_create")
     * @Method("POST")
     * @Template("NetpublicCoreBundle:HorarioGrupo:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new HorarioGrupoType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
     ...
     *
     * @Route("/{id}/update", name="horariogrupo_update")
     * @Method("POST")
     * @Template("NetpublicCoreBundle:HorarioGrupo:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}/delete", name="horariogrupo_delete")
     * @Method("POST")
     */
