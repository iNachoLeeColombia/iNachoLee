...
/**
 * Description of ConfiguracionGlobal
 *
 * @author yuri
 */
namespace Netpublic\CoreBundle\DataFixtures\ORM;
...
class ConfiguracionGlobal  extends AbstractFixture implements OrderedFixtureInterface {
    function load(ObjectManager $gestor){
       ...
       $profesor->setTipo(1);
        ...
        $password = $encoder->encodePassword("bermu4523", $usuario1->getSalt());
